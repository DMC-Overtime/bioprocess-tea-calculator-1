...
Input = [];
Input[7] = 3.05;// selling Price
Input[18] = 0.18; // GlucoseCosts[i];
const myChemical = new chemical();
myChemical.carbon = 3;
myChemical.hydrogen = 7;
myChemical.oxygen = 2;
myChemical.nitrogen = 1;
petroIRR = 30;
...
// UltraFiltration
    ...
    // Opex
       ...
       // Capex
            ...
            UFequipCost = 1.66*33837.28*(Math.pow(UFFlowM3hr,0.62)); //1996 dollars to 200 dollar
...
// CACA Chromatography
    // Opex
            CACAInVolume = annualUltrafiltrationOutVolume; // Liters
            ...
            CACAnaohCosts= ((AERresin*HydroxidePerSiteForRegeneration*BindingCapacityAER)/(2*39.997*1000)*CACACyclesPerYear)*NaOHCosts; // kg /yr
...
// Primary evaporator
    // Opex
        ...
        PrimEvapInFlowWater = PrimEvapFlow -dspRATE; // kg
        PrimEvapOutFlowWater = dspRATE/PrimEvapOutletConcentration - dspRATE;
...
// Secondary evaporator
    // Opex
        ...
        SecEvapInFlowWater = SecEvapFlow -dspRATE; // kg
        SecEvapOutFlowWater = dspRATE/SecEvapOutletConcentration - dspRATE;
        ...
        console.log('Sec Evap Nat Gas Costs: ' +SecEvapNatGasCosts );
            ...
            SecEvapaverageCoolingWaterFlowRate = (SecEvapcumulativeCoolingWaterNeeded/annualFermentationUpTime)/3600; // m3/sec
...
// DSP Totals
    ...
    annualDSPOpex  = annualUFopex +CACAOpex + PrimEvapOpex +SecEvapOpex ; //
    DSPEquip =  UFequipCost + CACAEquipment +PrimEvapEquip +SecEvapEquip  ;
    dspTIC =  ( UFequipTIC + CACATIC + PrimEvapTIC+ SecEvapTIC);
