  function OpexPieChart(bioprocessOutputs) {
    ...
    costOfCentrifugationperkg = (bioprocessOutputs.costOfCentrifugationperkg).toFixed(4) ;
    dspOPEXperkg = (bioprocessOutputs.dspOPEXperkg).toFixed(4) ;
    data1 = [costOfGlucoseperkg,costOfAmmoniaperkg,costOfMediaperkg,costOfAerationperkg,costOfCoolingperkg ,costOfBiomassDisposalperkg ,costOfSterilizationperkg, costOfLaborperkg, dspOPEXperkg, otherFixedCostsperkg, costOfCentrifugationperkg];
    console.log("costOfCentrifugationperkg: ", costOfCentrifugationperkg)

     let myOpexPieChart= document.getElementById("myOpexPieChart").getContext('2d');
     let myOpexPieChart1 = new Chart(myOpexPieChart, {
        type:'doughnut',
        data:{
            labels:["Glucose","Ammonia","Media","Aeration","Cooling","Biomass Disposal","Sterilization","Labor","DSP","Other Fixed Costs","Centrifugation" ],
            datasets:[{
              label:"Opex in $/kg",
              data:data1,
